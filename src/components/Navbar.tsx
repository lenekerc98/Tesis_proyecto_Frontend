        ...
        >
            <div className="d-flex align-items-center justify-content-between w-100">
                ...
                <div className="position-relative">
                    ...
                    <div
                        className="profile-trigger d-flex align-items-center gap-2 p-1 pe-3 shadow-sm border bg-white user-select-none"
                        style={{ cursor: 'pointer', transition: 'all 0.2s', borderRadius: '10px' }}
                    ...
                    {showProfileMenu && (
                        <>
                            ...
                            {/* LA VENTANA DEL MENÚ */}
                            <div className="position-absolute end-0 mt-3 bg-white shadow-lg border overflow-hidden profile-dropdown-menu animate__animated animate__fadeIn"
                                style={{ minWidth: '260px', zIndex: 999, borderRadius: '10px' }}>
